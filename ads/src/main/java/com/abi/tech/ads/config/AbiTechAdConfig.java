package com.abi.tech.ads.config;
...
public class AbiTechAdConfig {
    ...
    public AbiTechAdConfig(Application application) {
        this.application = application;
    }

    public AbiTechAdConfig(Application application, String environment) {
