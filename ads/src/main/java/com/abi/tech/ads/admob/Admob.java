...
import com.abi.tech.ads.dialog.PrepareLoadingAdsDialog;
import com.abi.tech.ads.event.AbiLogEventManager;

import com.abi.tech.ads.billing.AppPurchase;
import com.abi.tech.ads.funtion.AdCallback;
import com.abi.tech.ads.funtion.AdType;
import com.abi.tech.ads.funtion.AdmobHelper;
import com.abi.tech.ads.funtion.RewardCallback;
import com.abi.tech.ads.util.SharePreferenceUtils;
import com.abi.tech.ads.R;
...
public class Admob {
    ...
    public void onShowSplash(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterstitialSplash.setOnPaidEventListener(adValue -> {
            AbiLogEventManager.logPaidAdImpression(context,
                    adValue,
                    mInterstitialSplash.getAdUnitId(),
                    mInterstitialSplash.getResponseInfo()
                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
            if (tokenAdjust != null) {
                AbiLogEventManager.logPaidAdjustWithToken(adValue, mInterstitialSplash.getAdUnitId(), tokenAdjust);
            }
        });
        ...
        mInterstitialSplash.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                AbiLogEventManager.logClickAdsEvent(context, mInterstitialSplash.getAdUnitId());
            }
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            AbiLogEventManager.logPaidAdImpression(context,
                                    ...
                                    interstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
                            if (tokenAdjust != null) {
                                AbiLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), tokenAdjust);
                            }
                        });
                    }
    ...
    public void showInterstitialAdByTimes(final Context context, InterstitialAd mInterstitialAd, final AdCallback callback) {
        ...
        mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                AbiLogEventManager.logClickAdsEvent(context, mInterstitialAd.getAdUnitId());
            }
        });
        ...
        try {
            ...
            adView.setAdListener(new AdListener() {
                ...
                public void onAdLoaded() {
                    ...
                    if (adView != null) {
                        adView.setOnPaidEventListener(adValue -> {
                            ...
                            if (tokenAdjust != null) {
                                AbiLogEventManager.logPaidAdjustWithToken(adValue, adView.getAdUnitId(), tokenAdjust);
                            }
                        });
                    }
                ...
                public void onAdClicked() {
                    ...
                    AbiLogEventManager.logClickAdsEvent(context, id);
                }
        ...
        AdLoader adLoader = new AdLoader.Builder(context, id)
                .forNativeAd(nativeAd -> {
                    ...
                    nativeAd.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            AbiLogEventManager.logPaidAdjustWithToken(adValue, id, tokenAdjust);
                        }
                    });
                })
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                ...
                Admob.this.rewardedAd.setOnPaidEventListener(adValue -> {
                    AbiLogEventManager.logPaidAdImpression(context,
                            ...
                            , AdType.REWARDED);
                    if (tokenAdjust != null) {
                        AbiLogEventManager.logPaidAdjustWithToken(adValue, rewardedAd.getAdUnitId(), tokenAdjust);
                    }
                });
            }
        ...
        if (rewardedAd == null) {
            ...
            Admob.this.rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    ...
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                    AbiLogEventManager.logClickAdsEvent(context, rewardedAd.getAdUnitId());
                }
            });
    ...
    public void showRewardInterstitial(final Activity activity, RewardedInterstitialAd rewardedInterstitialAd, final RewardCallback adCallback) {
        ...
        if (rewardedInterstitialAd == null) {
            ...
            rewardedInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    super.onAdClicked();
                    AbiLogEventManager.logClickAdsEvent(activity, rewardedAd.getAdUnitId());
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                }
            });
